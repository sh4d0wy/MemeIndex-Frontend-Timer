...
const Timer = () => {
  ...
  return (
    <div className="flex gap-2 px-3 w-[100vw] justify-center items-center relative z-20 ">
...
const TimeBox = ({ value, label }: TimeBoxProps) => {
  return (
    <div className="flex flex-col items-center  w-full">
      <div className="w-full flex-1/4 h-full py-4 bg-[#002dfe] rounded-lg flex items-center justify-center 
