  ...
  return (
    <div className='flex flex-col gap-4 absolute bottom-4 left-0 right-0 p-4 z-20 w-full'>
      ...
      <div className='flex  gap-2 '>
        <button className='bg-white w-full py-4 rounded-xl text-blue-400 font-bold text-2xl flex items-center justify-center gap-2 transition-all duration-300  '>
        ...
        <button className='bg-white text-blue-400 w-1/5 py-4 rounded-xl text-2xl flex items-center justify-center gap-2 transition-all duration-300  ' >
